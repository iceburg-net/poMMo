...
<p><img src="{$url.theme.shared}images/icons/cells.png" class="articleimg" alt="table cells icon"/> {t escape=no 1='<strong>' 2='</strong>' 3='<tt>' 4='</tt>'}You can import subscribers from %1 CSV %2 files. Your CSV file should have one subscriber(email) per line with field information seperated by commas(%3,%4).{/t}</p>
