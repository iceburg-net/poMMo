...
<div><a href="{$url.base}admin/setup/setup_configure.php"><img src="{$url.theme.shared}images/icons/settings.png" alt="settings icon" class="navimage" />{t}Configure{/t}</a> - {t}Set your mailing list name, its default behavior, and the administrator's information.{/t}</div>
