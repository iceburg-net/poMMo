...
<div><a href="{$url.base}user/subscribe.php"><img src="{$url.theme.shared}images/icons/form.png" alt="form icon" class="navimage" />{t}Default Subscription Form{/t}</a> - {t}Preview the default subscription form. Its look and feel can be adjusted through the theme template ([theme]/user/subscribe.tpl).{/t}</div>
