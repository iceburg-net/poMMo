...
<input type="text" class="text" size="32" maxlength="60" name="subject" value="{$subject|escape}" id="subject" />
...
<input type="text" class="text" size="32" maxlength="60" name="fromname" value="{$fromname|escape}" id="fromname" />
<div class="notes">{t}(maximum of 60 characters){/t}</div>
</div>
...
<input type="text" class="text" size="32" maxlength="60" name="fromemail" value="{$fromemail|escape}" id="fromemail" />
<div class="notes">{t}(maximum of 60 characters){/t}</div>
</div>
...
<input type="text" class="text" size="32" maxlength="60" name="frombounce" value="{$frombounce|escape}" id="frombounce" />
<div class="notes">{t}(maximum of 60 characters){/t}</div>
</div>
