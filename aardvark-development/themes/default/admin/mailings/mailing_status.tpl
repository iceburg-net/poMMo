...
<script type="text/javascript" src="{$url.theme.shared}js/scriptaculous/prototype.js"></script>
{/capture}
{include file="admin/inc.header.tpl"}

<p><img src="{$url.theme.shared}images/icons/alert.png" class="articleimg" alt="thunderbolt icon" />
{t}The mailing process takes place in the background, so feel free to close your browser, visit other sites. Throttle settings can be adjusted, although you must pause and revive a mailings before the changes take effect.{/t}</p>
...
<img src="{$url.theme.shared}images/icons/pause-small.png" alt="pause icon" />
{t}Pause Mailing{/t}
</a> 
</span>
...
{t}Resume Mailing{/t}
<img src="{$url.theme.shared}images/icons/restart-small.png" alt="restart icon" />
</a>
</span>
</div>
...
{t}Cancel Mailing{/t}
<img src="{$url.theme.shared}images/icons/stopped-small.png" alt="stopped icon" />
</a>
</span>
</div>
